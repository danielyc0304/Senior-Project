...
argument-hint: "Topic, paper title/DOI, and desired output (summary, critique, or literature review)."
...
1. Clarify scope (single paper, multi-paper review, or proposal support).
2. Extract citation metadata and normalize citation style requested by user.
3. Analyze with the 5-part framework (question, methods, findings, implications, limitations).
4. Synthesize evidence into an academically structured output.
5. Conclude with limitations, research gaps, and practical next steps.

Default depth: **complete academic analysis** (methodology + limitations + future directions), unless the user explicitly asks for a brief summary.

## Quality Checklist

- Claims are evidence-linked (no unsupported conclusions).
- Facts and interpretations are clearly separated.
- Methodological caveats and generalizability limits are explicitly stated.
- Citation format is internally consistent (APA/MLA/Chicago).
- Output follows clear section structure and formal academic tone.
...
_Citation:_ Cepeda, N. J., Pashler, H., Vul, E., Wixted, J. T., & Rohrer, D. (2006). Distributed practice in verbal recall tasks: A review and quantitative synthesis. _Psychological Bulletin, 132_(3), 354-380. https://doi.org/10.1037/0033-2909.132.3.354
...
_Note: Full citations in APA format_
...
Karpicke, J. D., & Roediger, H. L. (2008). The critical importance of retrieval for learning. _Science, 319_(5865), 966-968.

Dunlosky, J., Rawson, K. A., Marsh, E. J., Nathan, M. J., & Willingham, D. T. (2013). Improving students' learning with effective learning techniques. _Psychological Science in the Public Interest, 14_(1), 4-58.
